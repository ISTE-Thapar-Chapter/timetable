...
import { batchesList } from "@/utils/schedule";
        ...
        <section className="w-full mt-12 glass-card rounded-2xl p-6 md:p-8 border border-white/10">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
              ...
              <p className="text-sm text-white/60 mt-1">
                Free slots calculation prefers your locally saved batch changes. If no local data exists, it uses official college timetable data.
              </p>
            </div>
