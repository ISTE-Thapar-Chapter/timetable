...
export default function CalendarCallback() {
  ...
  // Get detailed message, error, or error_description from query params
  const message = searchParams.get("message") || 
                  searchParams.get("error") || 
                  searchParams.get("error_description") || 
                  (isSuccess ? "Operation completed successfully!" : "There was an issue processing your request.");
